...
RUN dnf -y install rrdtool httpd cpan perl-XML-Dumper rrdtool-perl perl-CGI net-snmp-perl
RUN cpan install RRD::Simple

RUN curl -O https://github.com/gjcarneiro/yacron/releases/download/0.19.0/yacron-0.19.0-x86_64-unknown-linux-gnu && \
